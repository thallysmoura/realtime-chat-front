    ...
    setContentModal(
      <section className='flex flex-col gap-3'>
        ...
        <div className='flex justify-end gap-2'>
          ...
          <Button2 variant='success' onClick={async () => {
            await enviarNumero()
            setShowModal(false)
          }}  >Sim</Button2>
        </div>
    ...
    <>
      {etapa === 'telefone' && (
        <main className="flex flex-col text-center justify-center items-center h-screen gap-3">
          ...
          <section className='mt-10'>
            <Button2 variant='success' onClick={confirmarNumero}>Continuar</Button2>
          </section>
      ...
      {etapa === 'codigo' && (
        ...
        <main className="flex flex-col text-center justify-center items-center h-screen gap-3">
          ...
          <section>
            <p className='text-[#156652] font-medium text-2xl'>Verifique {telefone}</p>
          </section>

          <section>
            <small className='text-gray-600 text-sm'>Enviamos um SMS com PIN de 6 digitos para seu telefone.</small>
          </section>
          ...
          <section className='flex justify-center flex-col gap-3'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <span className="text-gray-600 text-base mr-5">{formatarTimer(timer)}</span>
              <Button2 className='disabled:opacity-40 disabled:cursor-not-allowed' variant='success' onClick={validarCodigo} disabled={loading || codigo.length !== 6}>
        ...
        <main className="flex flex-col text-center justify-center items-center h-screen gap-3">
          ...
          <section className='flex justify-center flex-col gap-3'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <span className="text-gray-600 text-base mr-5">{formatarTimer(timer)}</span>
              <Button2 disabled className='disabled:opacity-40 disabled:cursor-not-allowed' variant='success' onClick={validarCodigo} >
                {loading ? 'Validando...' : 'Validar código'}
              </Button2>
            </div>
          </section>
      ...
      <Modal isOpen={showModal} onClose={setShowModal} title={titleModal} existHeader={true} headerColor='bg-[#405DA1]' >
        {contentModal}
      </Modal>
