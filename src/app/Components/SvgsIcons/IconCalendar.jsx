...
const IconCalendar = ({ width=4 , color="text-gray-400", height=4, ...props }) => {
    return (
        <svg className={`w-${width} h-${height} ${color}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
